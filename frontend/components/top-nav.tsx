...
import { Sparkles, LogOut, Settings, User as UserIcon, ChevronDown, Moon, Sun } from "lucide-react";
...
export function TopNav({ user, onLogout, onOpenProfile, onOpenSettings }: TopNavProps) {
